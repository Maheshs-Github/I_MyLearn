...
// export { ArcsData, CharData };
// export {Arcs,Chars}={ArcsData,CharData}  wrong one
export const Arcs = ArcsData;
export const Chars = CharData;
// export { ArcsData as Arcs, CharData as Chars };
